const categories = [
    {
      ...
      dishes: [
        ...
        { id: 6, name: "Суши с крабом", description: "Мясо краба, рис, нори", price: "17.99₽", image: "https://via.placeholder.com/150/4682B4" },
        { id: 7, name: "Суши с мидиями", description: "Мидии, рис, нори", price: "18.99₽", image: "https://via.placeholder.com/150/2E8B57" },
      ],
    },
    {
      title: "Суши",
      dishes: [
        { id: 8, name: "Ролл Калифорния", description: "Крабовые палочки, авокадо, огурец", price: "15.99₽", image: "https://via.placeholder.com/150/4682B4" },
    ...
    },
    {
      title: "Сеты",
      dishes: [
        { id: 15, name: "Сет Ассорти", description: "Роллы, суши, нигири", price: "55.99₽", image: "https://via.placeholder.com/150/FFC0CB" },
        { id: 16, name: "Сет Семейный", description: "Роллы и суши для всей семьи", price: "60.99₽", image: "https://via.placeholder.com/150/800080" },
    ...
    },
    {
      title: "Закуски",
      dishes: [
        { id: 22, name: "Эдамаме", description: "Зелёные соевые бобы", price: "7.99₽", image: "https://via.placeholder.com/150/2E8B57" },
    ...
    },
    {
      title: "Салаты",
      dishes: [
        { id: 29, name: "Салат Чука", description: "Морские водоросли с соусом", price: "9.99₽", image: "https://via.placeholder.com/150/800080" },
